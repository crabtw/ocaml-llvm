...
(* OASIS_START *)
(* DO NOT EDIT (digest: ba934eede3484b20c9e3de3ba9ff23db) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, ["${cflags}"])];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "W\203Q\t\006\181\232\159>+\147@@\209\221\140";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
...
let check_llvm_ver bin = let open BaseSetup in
  BaseCheck.version "llvm" (OASISVersion.VGreaterEqual setup_t.package.version) (fun () ->
    let ver = OASISExec.run_read_one_line ~ctxt:!BaseContext.default bin ["--version"] in
...
let () =
  ...
  let _ = check_llvm_ver llvm_config () in
  ()
